<v-image-search>
    <button
        ...
        aria-label="<?php echo app('translator')->get('shop::app.search.images.index.search'); ?>"
    >
    </button>
</v-image-search>

<?php if (! $__env->hasRenderedOnce('d49c17f0-6e42-49eb-b793-30d128704569')): $__env->markAsRenderedOnce('d49c17f0-6e42-49eb-b793-30d128704569');
                    ...
                    if (imageInput.files && imageInput.files[0]) {
                        if (imageInput.files[0].type.includes('image/')) {
                            if (imageInput.files[0].size <= 2000000) {
                                ...
                                this.$axios.post('<?php echo e(route('shop.search.upload')); ?>', formData, {
                                        headers: {
                                    ...
                                    .then(response => {
                                        ...
                                        async function app() {
                                            ...
                                            try {
                                                ...
                                                this.$emitter.emit('add-flash', { type: 'error', message: "<?php echo app('translator')->get('shop::app.search.images.index.something-went-wrong'); ?>"});
                                            }
                                            ...
                                            window.location.href = `${'<?php echo e(route('shop.search.index')); ?>'}?query=${queryString[0]}&image-search=1`;
                                        }
                                ...
                                this.$emitter.emit('add-flash', { type: 'error', message: '<?php echo app('translator')->get('shop::app.search.images.index.size-limit-error'); ?>'});
                            ...
                            this.$emitter.emit('add-flash', { type: 'error', message: '<?php echo app('translator')->get('shop::app.search.images.index.only-images-allowed'); ?>'});
...
<?php $__env->stopPush(); endif; ?><?php /**PATH /var/www/html/bagisto/packages/Webkul/Shop/src/resources/views/search/images/index.blade.php ENDPATH**/ ?>