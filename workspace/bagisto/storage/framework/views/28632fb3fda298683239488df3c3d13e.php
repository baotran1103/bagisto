<?php if(Webkul\Product\Helpers\ProductType::hasVariants($product->type)): ?>
    ...
    <?php $__env->startPush('scripts'); ?>
                ...
                >
                    ...
                    <template v-else>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            >
                                <?php echo app('translator')->get('shop::app.products.view.type.configurable.select-above-options'); ?>
                            </span>
                        </div>
                    </template>
        ...
        <script type="module">
            let galleryImages = <?php echo json_encode(product_image()->getGalleryImages($product), 15, 512) ?>;
            ...
            app.component('v-product-configurable-options', {
                ...
                data() {
                    return {
                        config: <?php echo json_encode(app('Webkul\Product\Helpers\ConfigurableOption')->getConfigurationConfig($product), 15, 512) ?>,
                ...
                methods: {
                    ...
                    fillAttributeOptions(attribute) {
                        ...
                        attribute.options = [{
                            'id': '',
                            'label': "<?php echo app('translator')->get('shop::app.products.view.type.configurable.select-options'); ?>",
                            'products': []
                        }];
...
<?php endif; ?><?php /**PATH /var/www/html/bagisto/packages/Webkul/Shop/src/resources/views/products/view/types/configurable.blade.php ENDPATH**/ ?>