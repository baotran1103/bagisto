...
<?php if (! $__env->hasRenderedOnce('7e3f6786-c2ce-4aa4-95bd-b86f703a6ca9')): $__env->markAsRenderedOnce('7e3f6786-c2ce-4aa4-95bd-b86f703a6ca9');
        ...
        <div>
            <div class="flex items-center gap-4">
                <p class="text-base max-sm:text-sm">
                    <?php echo app('translator')->get('shop::app.components.range-slider.range'); ?>
                </p>
                ...
                <div class="relative h-1 w-full rounded-2xl bg-gray-200">
                    ...
                    <span>
                        <input
                            ...
                            :min="allowedMinRange"
                            :max="allowedMaxRange"
                            aria-label="<?php echo app('translator')->get('shop::app.components.range-slider.min-range'); ?>"
                            @input="handle('min')"
                            @change="change"
                        >
                    </span>
                    ...
                    <span>
                        <input
                            ...
                            :min="allowedMinRange"
                            :max="allowedMaxRange"
                            aria-label="<?php echo app('translator')->get('shop::app.components.range-slider.max-range'); ?>"
                            @input="handle('max')"
                            @change="change"
                        >
                    </span>
...
<?php /**PATH /var/www/html/bagisto/packages/Webkul/Shop/src/resources/views/components/range-slider/index.blade.php ENDPATH**/ ?>