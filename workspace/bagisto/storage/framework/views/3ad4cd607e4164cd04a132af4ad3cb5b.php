<?php if(
    ...
    <?php if (! $__env->hasRenderedOnce('3de1bfd9-b3ec-4d31-b439-d4d7cdf60684')): $__env->markAsRenderedOnce('3de1bfd9-b3ec-4d31-b439-d4d7cdf60684');
                ...
                methods: {
                    register() {
                        if (typeof paypal == 'undefined') {
                            this.$emitter.emit('add-flash', { type: 'error', message: '<?php echo app('translator')->get('paypal::app.errors.invalid-configs'); ?>' });
                        ...
                        let options = {
                                ...
                                return this.$axios.get("<?php echo e(route('paypal.smart-button.create-order')); ?>")
                                    ...
                                    .catch(error => {
                                        if (error.response.data.error === 'invalid_client') {
                                            ...
                                            options.alertBox('<?php echo app('translator')->get('paypal::app.errors.invalid-configs'); ?>');
                                        }
                            ...
                            onError: (error) => {
                                if (! options.authorizationFailed) {
                                    options.alertBox('<?php echo app('translator')->get('paypal::app.errors.something-went-wrong'); ?>');
                                }
                            },
                        };
...
<?php endif; ?>
<?php /**PATH /var/www/html/bagisto/packages/Webkul/Paypal/src/resources/views/checkout/onepage/paypal-smart-button.blade.php ENDPATH**/ ?>